...
These requirements cover the full Librio MVP described in the D01 proposal. Sprint 1 is the first execution milestone, not the whole product.

### Sprint 1 Discovery & Availability
...
### Physical Circulation Lifecycle
...
### Digital Access & Library Operations
...
- LIB-01 through LIB-06 use the frozen Sprint 1 SRS definitions in docs/srs/sprint-1-srs.md; Phase 1 API behavior is governed by docs/lld/api-contracts/sprint-1-api.md.
- LIB-07 through LIB-11 are the future PBI boundaries in Mock/D02_Librio_Product_Backlog_WBS.xlsx, expanded only to the detail explicitly present in the D01 proposal and HLD.
...
| LIB-10 | Phase 4 | Pending |
| LIB-11 | Phase 4 | Pending |
...
*Last updated: 2026-08-19 after initial roadmap creation*
