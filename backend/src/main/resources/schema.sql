...
CREATE INDEX IF NOT EXISTS idx_borrowing_active_due
    ...
    WHERE returned_at IS NULL;
A L T E R   T A B L E   a c c o u n t s   A D D   C O L U M N   I F   N O T   E X I S T S   m e m b e r s h i p _ e l i g i b l e   B O O L E A N   N O T   N U L L   D E F A U L T   f a l s e ;  
