...
public class BorrowRequestController {
    ...
    public ResponseEntity<ReaderBorrowRequestItemDto> create(@Valid @RequestBody CreateBorrowRequestDto body) {
        Account reader = currentAccountService.getCurrentAccount();
        ReaderBorrowRequestItemDto response = borrowService.createRequest(reader.getId(), body.getResourceId());
